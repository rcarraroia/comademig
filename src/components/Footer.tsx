...
const Footer = () => {
  return <footer className="bg-comademig-blue text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Logo e Descrição */}
          <div className="space-y-4">
            <img src="/lovable-uploads/cc23f58f-2f47-4114-9910-081739a7ea69.png" alt="COMADEMIG Logo" className="h-16 w-auto" />
            <p className="font-inter leading-relaxed text-center text-sm text-slate-100">Convenção de Ministros das Assembleias de Deus em Minas Gerais.
Fortalecendo o Reino de Deus através da unidade ministerial.</p>
          </div>
      ...
      {/* WhatsApp Flutuante */}
      <a href="https://wa.me/5531999999999" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 z-50">
