-- ============================================
-- RECRIAR TABELA NOTÍCIAS COM SCHEMA CORRETO
-- ============================================
-- Data: 2025-10-17
-- Objetivo: Dropar tabela antiga e recriar com estrutura completa
-- Motivo: Tabela antiga tinha estrutura diferente e está vazia
-- ============================================
...
COMMENT ON COLUMN noticias.conteudo_completo IS 'Conteúdo completo da notícia';
