...
- [ ] 2. Implementar serviços core do novo fluxo
...
- [ ] 4. Implementar PaymentFirstFlowService principal
  ...
  - [ ] 4.3 Implementar criação de cliente Asaas
  ...
  - [ ] 4.4 Implementar processamento de pagamento com split
...
- [ ] 5. Implementar criação condicionada de contas
  - [ ] 5.1 Criar lógica de criação de conta Supabase
  ...
  - [ ] 5.3 Implementar criação de perfil com status ativo
  ...
  - [ ] 5.5 Implementar criação de assinatura
...
- [ ] 7. Implementar Edge Functions
  - [ ] 7.1 Criar Edge Function process-payment-first-registration
  ...
  - [ ] 7.3 Criar Edge Function poll-payment-status
  ...
  - [ ] 7.4 Criar Edge Function process-pending-subscriptions
    - Implementar processamento de cron job para pendings
    - Configurar retry automático
    - Adicionar notificação de falhas críticas
    - _Requirements: 4.2, 4.3_

  - [ ] 7.5 Criar Edge Function process-pending-completions
...
- [ ] 8. Integrar formulário de filiação com PaymentFirstFlow
  - [ ] 8.1 Criar adapter de dados entre formulário atual e PaymentFirstFlow
  ...
  - [ ] 8.2 Refatorar useFiliacaoPayment para usar PaymentFirstFlowService
  ...
  - [ ] 8.3 Atualizar validações do formulário
  ...
  - [ ] 8.4 Implementar compatibilidade com sistema admin
  ...
  - [ ] 8.5 Adicionar feature flag para migração gradual
  ...
  - [ ] 8.6 Testes de integração do formulário
...
- [ ] 9. Checkpoint - Validar integração completa
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 9. Checkpoint - Validar integração do formulário
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. Implementar componentes frontend avançados
  - [ ] 10.1 Refatorar FiliacaoForm para novo fluxo
    - Remover lógica de criação imediata de conta
    - Integrar com nova Edge Function
    - Adicionar estados de loading e progresso
    - _Requirements: 7.1_

  - [ ] 10.2 Atualizar tela de aguardo (loading inline)
  ...
  - [ ]* 10.3 Escrever testes de propriedade para UX
...
- [ ] 11. Checkpoint - Validar integração frontend avançada
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 12. Implementar sistema de monitoramento
  - [ ] 12.1 Criar dashboard de monitoramento
    - Implementar métricas de sucesso de registro
    - Adicionar visualização de performance
    - Criar alertas para falhas críticas
    - _Requirements: 8.3, 8.4_

  - [ ] 12.2 Implementar logging detalhado
  ...
  - [ ]* 12.3 Escrever testes de propriedade para monitoramento
